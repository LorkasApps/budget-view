...
| 035-skewed-receipt-shifts-prices.md | Bug | Drilldown | Drilldown | Draft | None | A few degrees of skew pair every price with the neighbouring item, silently — poisons drilldown, report and trends |
