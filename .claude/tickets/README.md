...
| 031-theme-mode-setting.md | Feature | Setup | Infra | In Progress | None | Theme mode row in Settings: Dunkel / Hell / Systemvorgabe (default), dark scheme from the same teal seed |
