...
| receipt-scan.md | Drilldown | Ephemeral receipt photo capture: source picker, deskew, doc-hash check, OCR/parser seams, confirm → line-items + ImportedSource, printed total checksum banner |
