...
| analytics.md | Analytics | Monthly category report: rollup service, donut + tree table, month/account/direction filters, subtree drilldown; linear-regression forecast on the same rollup, chart + entry points |
